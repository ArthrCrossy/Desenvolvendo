...
class Lista {
    ...
    public boolean pesquisaSequencial(String palavra){
...
//        MyIO.setCharset("UTF-8");
        ...
        for(i = 0; i < l; i =i + 1){
            cont = cont + 1;
            if(x.pesquisaSequencial(vetorString[i])){
                MyIO.println("SIM");
            }else{
                MyIO.println("NÃO");
            }
        ...
        Arq.openWrite("713229_sequencial_comparacoes.txt");
        Arq.print("713229 " + time +" " + cont);
