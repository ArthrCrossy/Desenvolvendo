...
public class algebra {
    ...
    public static char[] or(char[] entrada,int j, int stop, int answer, boolean ehtrue, boolean continuar, int i){
		...
		for(i=j ;i< (entrada.length); i = i + 1 ){
	...
	/*
	public static char[] limpaFuncaoAnd(char[] entrada, int i, int j, int stop, int answer, int h){
		...
		if(i <= stop){
			...
			limpaFuncaoAnd(entrada, i, j, stop, answer, h);
		}
    ...
    public static char[] not(char[] entrada,int j, boolean encontrou, int stop, int i, int cont){
			...
			entrada = limpaFuncaoNot(entrada, i = j - 3, stop, entrada.length);
	...
	// limpa os caracteres
	public static char[] limpaFuncaoNot(char entrada[], int i, int stop, int tam){
		...
		if(i < stop){
			...
			limpaFuncaoNot(entrada, i, stop, tam);
		}
