...
class lista {
    ...
    public void mergeTemp(int esq, int meio, int dir){

        int n1 = meio - esq + 1;
        int n2 = dir - meio;
  
        Filmes L[] = new Filmes [n1];
        Filmes R[] = new Filmes [n2];
        ...
        while (i < n1 && j < n2) {
            if (L[i].getNumberTemp() <= R[j].getNumberTemp()) {
                array[k] = L[i];
                i = i + 1;
            }else {
                array[k] = R[j];
    ...
    public void merge(int esq, int meio, int dir){
        ...
        while (i < n1 && j < n2) {
            if (L[i].getNumberEp() <= R[j].getNumberEp()) {
                array[k] = L[i];
                i = i + 1;
            }else {
                array[k] = R[j];
    ...
    public void sortTemp(int esq, int dir){
