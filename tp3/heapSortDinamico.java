...
class lista {
    ...
    public void quickSort(int esq, int dir) {
        ...
        Filmes pivo = array[(dir+esq)/2];

        while ((i <= j)){

            while (((array[i].getPais().compareTo(pivo.getPais()) < 0) || (array[i].getPais().compareTo(pivo.getPais()) == 0) && (array[i].getNome().compareTo(pivo.getNome()) < 0 ))){ 
                i++;
            }
            while (((array[j].getPais().compareTo(pivo.getPais()) > 0) || (array[j].getPais().compareTo(pivo.getPais()) == 0) && (array[j].getNome().compareTo(pivo.getNome()) > 0))){ 
                j--;
            }
            if (i <= j) {
                swap(i, j);
    ...
    public void construir(int tamHeap){
        for(int i = tamHeap; (i > 1) && ((array[i].getFormato().compareTo(array[i/2].getFormato()) > 0) || (array[i].getFormato().equals(array[i/2].getFormato())) && (array[i].getNome().compareTo(array[i/2].getNome()) > 0)); i /= 2){
           swap(i, i/2);
        }
    }
    ...
    public void reconstruir(int tamHeap){
        ...
        while(i <= (tamHeap/2)){
           ...
           if((array[i].getFormato().compareTo(array[filho].getFormato()) < 0) || (array[i].getFormato().equals(array[filho].getFormato())) && (array[i].getNome().compareTo(array[filho].getNome())) < 0){
                swap(i, filho);
                i = filho;
         }else{
                i = tamHeap;
    ...
    public int getMaiorFilho(int i, int tamHeap){
        ...
        if (2*i == tamHeap || (array[2*i].getFormato().compareTo(array[2*i+1].getFormato()) > 0) || (array[2*i].getFormato().equals(array[2*i+1].getFormato())) && (array[2*i].getNome().compareTo(array[2*i+1].getNome()) > 0)){
           filho = 2*i;
        } else {
           filho = 2*i + 1;
        }
