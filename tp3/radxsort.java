...
class lista {
    ...
    public int getMaior(){
        ...
        for(int i = 0; i < array.length; i = i + 1){
            ...
            if(maior < array[i].getNumberTemp()){
                maior = array[i].getNumberTemp();
            }
    ...
    public void ordenarSecundario(){

        for(int i = 0; i < array.length; i = i + 1){

            for(int j = i + 1; j < array.length; j = j + 1){

            //    if(/*array[i].getPais() == array[j].getPais()*/array[i].getPais().compareTo(array[j].getPais()) == 0){
    ...
    public void countSort(int exp) {
        ...
        for (int i = 0; i < n; i=i+1) {
        comp = comp + 1;
        count[((array[i].getNumberTemp()*1000+array[i].getNumberEp()) / exp)%1000]++;
        ...
        for (int i = n - 1; i >= 0; i=i-1) {
            comp = comp + 1;
            mov = mov + 1;
            output[count[((array[i].getNumberTemp()*1000+array[i].getNumberEp())/exp)%1000]-1] = array[i];
            comp = comp + 1;
            mov = mov + 1;
            count[(array[i].getNumberTemp()*1000+array[i].getNumberEp()/exp)%1000]--;
        }
 ...
 public class radxsort {
    ...
    public static int getMax(lista x, int n){

        int maior = 0;

        for(int i = 0; i < n; i = i + 1){
            
            if(maior < x.array[i].getNumberTemp()){
                maior = x.array[i].getNumberTemp();
            }
